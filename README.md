...
1. Keep all k8s node as least 2 CPUS for the vm setting.

2. Stop firewalld and selinux
...
3. Install docker k8s packages
    ...
    # Install kubernetes
    yum install kubelet-1.17.2 kubeadm-1.17.2 kubectl-1.17.2 -y
    ```


4. Download docker image from ali docker mirrors 
...
5. Remove all images if the version is incorrect

    ```
    docker rmi $(docker images -q) -f
    ```
6. Keep nf bridge to 1
...
10. Enable and start docker kubelet
...
11. kubeadm init
  - master:
    ...
    imageRepository: registry.cn-hangzhou.aliyuncs.com/showerlee
...
14. Check node
    ...
    kube-master   NotReady   master   24m   v1.17.2
    kube-node1    NotReady   <none>   24m   v1.17.2
    ```

15. Install flannel to make node ready
...
16. Verify the setup
    ...
    kubectl get nodes
    NAME          STATUS   ROLES    AGE   VERSION
    kube-master   Ready    master   61m   v1.17.2
    kube-node1    Ready    <none>   50m   v1.17.2
